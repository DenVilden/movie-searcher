  ...
  & { movieInfo?: Types.Maybe<(
    ...
    & { similar: (
      ...
      & { results: Array<(
        ...
        & Pick<Types.SimilarResults, 'id' | 'title' | 'release_date' | 'poster_path'>
      )> }
    ) }
  )> }
);
...
export type GetMoviesQuery = (
  ...
  & { upcoming: (
    { __typename?: 'Upcoming' }
    & Pick<Types.Upcoming, 'total_pages' | 'page'>
    & { results: Array<(
      { __typename?: 'UpcomingResults' }
      & Pick<Types.UpcomingResults, 'id' | 'title' | 'release_date' | 'poster_path'>
    )> }
  ), topRated: (
    { __typename?: 'TopRated' }
    & Pick<Types.TopRated, 'total_pages' | 'page'>
    & { results: Array<(
      { __typename?: 'TopRatedResults' }
      & Pick<Types.TopRatedResults, 'id' | 'title' | 'vote_average' | 'poster_path'>
    )> }
  ) }
);
